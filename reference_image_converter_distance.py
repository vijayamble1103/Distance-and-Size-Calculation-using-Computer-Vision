...
bicycle = config.get('distance_paths','Bicycle_path')
motorcycle = config.get('distance_paths', 'Motorcycle_path')
car = config.get('distance_paths', 'Car_path')
bus = config.get('distance_paths', 'Bus_path')
commercial = config.get('distance_paths', 'Commercial_path')
input_distance = config.get('distance_paths', 'input_distance')
...
def resized(image_path,image):
    ...
    cv.imwrite('./test/distance/'+basename+'.png', resized_image)
...
Bus_path = './Reference_Images/distance/Bus.png'
